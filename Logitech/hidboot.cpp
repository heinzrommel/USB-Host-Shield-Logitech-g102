...
void MouseReportParser::Parse(USBHID *hid __attribute__((unused)), bool is_rpt_id __attribute__((unused)), uint8_t len __attribute__((unused)), uint8_t *buf) {
        ...
        if (prevState.mouseInfo.bmX1Button == 1 && pmi->bmX1Button == 0)
                OnX1ButtonUp(pmi);
        if (prevState.mouseInfo.bmX1Button == 0 && pmi->bmX1Button == 1)
                OnX1ButtonDown(pmi);
        if (prevState.mouseInfo.bmX2Button == 1 && pmi->bmX2Button == 0)
                OnX2ButtonUp(pmi);
        if (prevState.mouseInfo.bmX2Button == 0 && pmi->bmX2Button == 1)
                OnX2ButtonDown(pmi);
