...
struct MOUSEINFO {
        ...
        struct {
                ...
                uint8_t bmX1Button : 1;
                uint8_t bmX2Button : 1;
                uint8_t bmDummy : 3;
        };
        int8_t dX2;
        int8_t dX;
...
protected:
	...
	virtual void OnX1ButtonUp(MOUSEINFO *mi __attribute__((unused))) {
        };

        virtual void OnX1ButtonDown(MOUSEINFO *mi __attribute__((unused))) {
        };
		
	virtual void OnX2ButtonUp(MOUSEINFO *mi __attribute__((unused))) {
        };

        virtual void OnX2ButtonDown(MOUSEINFO *mi __attribute__((unused))) {
        };
